...
async function deployWithRetry(factory: any, name: string, args: any[] = [], maxRetries = 3) {
...
async function main() {
  ...
  try {
    ...
    throw new Error("❌ Failed to connect to RPC provider. Check your network configuration.");
  }
