      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/30 mb-8">
            ...
            <span className="text-emerald-300 text-sm font-medium">Live on 0G Aristotle • Zero Gas Fees</span>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-white/50 text-sm">0G Aristotle network confirms transactions in seconds, not minutes.</p>
            </div>
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-violet-600/20 to-cyan-600/20 rounded-2xl p-6 border border-violet-500/30 relative">
              ...
              <p className="text-white/70 text-sm mb-4">Gasless OINIO staking platform on 0G Aristotle. Zero fees, instant confirmation.</p>
              <div className="flex items-center justify-between">
                <span className="text-xs text-emerald-400 font-medium">CURRENT</span>
                <span className="text-xs text-white/50">Live on 0G Aristotle</span>
              </div>
            </div>
