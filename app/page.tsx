...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/30 mb-8">
            ...
            <span className="text-emerald-300 text-sm font-medium">
              Live on 0G Aristotle • Zero Gas Fees
            </span>
          </div>

          {/* Main Headline - OINIO ECOSYSTEM INTRODUCTION */}
          ...
          {/* Subhead - ECOSYSTEM VALUE PROPOSITION */}
          <p className="text-xl text-white/60 mb-8 max-w-2xl mx-auto">
            Ethical AI validation, gasless staking, and community governance on Pi Network.
            Join the consciousness revolution where blockchain meets artificial intelligence.
          </p>
      ...
      {/* REAL-TIME METRICS - ECOSYSTEM HEALTH */}
      <section className="py-16 px-6 bg-gradient-to-r from-violet-950/30 to-cyan-950/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-white/60">
              Real-time data from the OINIO network
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
              ...
              <div className="text-3xl font-bold text-white mb-1">${metrics.oinioPrice.toFixed(2)}</div>
              <div className="text-sm text-white/50">OINIO Price</div>
              <div className={`text-xs mt-1 ${metrics.priceChange >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
            ...
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
              <div className="text-2xl mb-2">🔒</div>
              <div className="text-3xl font-bold text-white mb-1">${metrics.tvl.toFixed(2)}</div>
              <div className="text-sm text-white/50">TVL</div>
              <div className={`text-xs mt-1 ${metrics.tvlChange >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
            ...
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
              <div className="text-2xl mb-2">👥</div>
              <div className="text-3xl font-bold text-white mb-1">{metrics.activeStakers.toLocaleString()}</div>
              <div className="text-sm text-white/50">Active Stakers</div>
              <div className="text-xs text-emerald-400 mt-1">+0</div>
            </div>

            {/* Total Staked */}
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10 text-center">
              <div className="text-2xl mb-2">📊</div>
              <div className="text-3xl font-bold text-white mb-1">{metrics.totalStaked.toLocaleString()} {metrics.tokenSymbol}</div>
              <div className="text-sm text-white/50">Total Supply</div>
              <div className="text-xs text-emerald-400 mt-1">+0</div>
            </div>
          </div>
          ...
          <div className="text-center mt-8">
            <p className="text-white/40 text-sm">
              Data updates every 30 seconds • Networks: Polygon & 0G Aristotle
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-white/60 mt-4 max-w-2xl mx-auto">
              Most platforms charge gas fees that eat into your rewards. We
              sponsor every transaction. You pay nothing. Ever.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-white/50 text-sm">
                We pay all transaction costs. Your tokens work for you, not for
                gas.
              </p>
            </div>
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-white/50 text-sm">
                0G Aristotle network confirms transactions in seconds, not
                minutes.
              </p>
            </div>
            <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-white/50 text-sm">
                No platform fees, no hidden charges. What you earn is what you
                keep.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="relative">
              ...
              <div className="bg-white/5 rounded-2xl p-8 pt-12 border border-white/10 h-full">
                ...
                <p className="text-white/60 mb-4">
                  Click &quot;Connect&quot; and approve in MetaMask. Works on
                  phone or desktop.
                </p>
            ...
            <div className="relative">
              ...
              <div className="bg-white/5 rounded-2xl p-8 pt-12 border border-white/10 h-full">
                ...
                <p className="text-white/60 mb-4">
                  Type how much OINIO you want to stake. Min 0.01, max 10,000
                  per transaction.
                </p>
            ...
            <div className="relative">
              ...
              <div className="bg-white/5 rounded-2xl p-8 pt-12 border border-white/10 h-full">
                ...
                <p className="text-white/60 mb-4">
                  Hit the button. We handle the gas. Transaction confirms in
                  seconds.
                </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-white/60 max-w-2xl mx-auto">
              A sovereign constellation of services for ethical AI, decentralized finance, and community governance.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 rounded-2xl p-8 border border-white/10 hover:bg-white/10 transition-colors group">
              ...
              <p className="text-white/70 text-sm mb-4">
                Ethical AI validation and consciousness framework. Deploy AI models with built-in governance and transparency.
              </p>
              <div className="flex items-center justify-between text-xs text-white/50">
                <span>Pi Network</span>
                <a href="https://github.com/onenoly1010/pi-forge-quantum-genesis" className="text-violet-400 hover:text-violet-300">
                  View →
                </a>
              </div>
            </div>
            ...
            <div className="bg-white/5 rounded-2xl p-8 border border-white/10 hover:bg-white/10 transition-colors group">
              ...
              <p className="text-white/70 text-sm mb-4">
                Stake OINIO tokens without paying gas fees. Meta-transactions powered by sponsor wallets on Polygon & 0G Aristotle.
              </p>
              <div className="flex items-center justify-between text-xs text-white/50">
                <span>Polygon + 0G</span>
            ...
            <div className="bg-white/5 rounded-2xl p-8 border border-white/10 hover:bg-white/10 transition-colors group">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-amber-300 font-medium">SOON</span>
                </div>
              </div>
              <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-violet-400 transition-colors">
                Sovereign DEX
              ...
              <p className="text-white/70 text-sm mb-4">
                Decentralized exchange for OINIO and other tokens. Community-owned liquidity and fair trading mechanics.
              </p>
              <div className="flex items-center justify-between text-xs text-white/50">
                <span>0G Aristotle</span>
          ...
          <div className="text-center mt-12">
            <p className="text-white/50 text-sm">
              All services are open source and connected through the sovereign ecosystem.
            </p>
            <a
              href="https://github.com/onenoly1010"
              target="_blank"
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-transparent to-cyan-950/20">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-white/60 mt-4 max-w-2xl mx-auto">
              Whether you&apos;re staking for the first time or you&apos;ve been
              in crypto for years.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/5 rounded-2xl p-8 border border-white/10">
              ...
              <ul className="space-y-3 text-white/70">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 mt-1">✓</span>
                  Token: 0xbEbC1A40A18632CeE19D220647E7aD296A1A5F37
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-400 mt-1">✓</span>
              ...
              <a
                href="https://github.com/onenoly1010/quantum-pi-forge-fixed"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block mt-6 text-violet-400 hover:text-violet-300"
              >
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-white/60 mt-4 max-w-2xl mx-auto">
              Every transaction is public. Every line of code is open. Nothing
              hidden.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-white/50 text-sm">
                Every stake appears on 0G Explorer. Verify your transaction
                instantly.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-white/50 text-sm">
                100% of our code is public on GitHub. Audit it, fork it, improve
                it.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-white/50 text-sm">
                See your balance, track your stakes, watch confirmations live.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-transparent to-emerald-950/20">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-white/60 mt-4 max-w-2xl mx-auto">
              Trade OINIO ↔ 0G directly on the 0G Aristotle network. Full
              sovereign control, zero intermediaries, pure decentralized
              exchange.
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-transparent to-indigo-950/20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-white/60 mt-4 max-w-2xl mx-auto">
              Multiple platforms working together for the Truth Movement. Each
              project serves a unique purpose in the sovereign economy.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-violet-600/20 to-cyan-600/20 rounded-2xl p-6 border border-violet-500/30 relative">
              ...
              <p className="text-white/70 text-sm mb-4">
                Gasless OINIO staking platform on 0G Aristotle. Zero fees,
                instant confirmation.
              </p>
              <div className="flex items-center justify-between">
            ...
            {/* AI Forge */}
            <a
              href="https://onenoly1010.github.io/Ai-forge-/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              ...
              <p className="text-white/70 text-sm mb-4">
                Ethical AI application builder. Create AI tools without coding.
              </p>
              <div className="flex items-center justify-between">
            ...
            <a
              href="https://pi-forge-quantum-genesis-1.onrender.com"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white/5 rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-colors group"
            >
              ...
              <p className="text-white/70 text-sm mb-4">
                Coordination and orchestration platform for sovereign systems.
              </p>
              <div className="flex items-center justify-between">
                <span className="text-xs text-cyan-400 font-medium">LIVE</span>
            ...
            {/* Quantum Resonance */}
            <a
              href="https://quantum-resonance-clean.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white/5 rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-colors group"
            >
              ...
              <p className="text-white/70 text-sm mb-4">
                Harmonic ledger and resonance analysis for frequency-based
                systems.
              </p>
              <div className="flex items-center justify-between">
            ...
            {/* Launch Countdown */}
            <a
              href="https://onenoly1010.github.io/countdown"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white/5 rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-colors group"
            >
              ...
              <p className="text-white/70 text-sm mb-4">
                Real-time countdown to major project launches and events.
              </p>
              <div className="flex items-center justify-between">
                <span className="text-xs text-cyan-400 font-medium">LIVE</span>
                <span className="text-xs text-white/50">GitHub Pages</span>
            ...
            <a
              href="https://quantum-pi-forge-fixed.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white/5 rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-colors group"
            >
              ...
              <p className="text-white/70 text-sm mb-4">
                Advanced staking interface with real-time monitoring and
                analytics.
              </p>
              <div className="flex items-center justify-between">
                <span className="text-xs text-cyan-400 font-medium">LIVE</span>
          ...
          <div className="text-center mt-12">
            <p className="text-white/50 text-sm">
              All projects are open source and connected through the sovereign
              ecosystem.
            </p>
            <a
              href="https://github.com/onenoly1010"
      ...
      <footer className="border-t border-white/5 py-12 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-white/60 text-sm">
                OINIO Soul System • Sovereign Staking
              </span>
            </div>
            <div className="flex items-center gap-6 text-sm text-white/40">
              <Link href="/for-humans" className="hover:text-white/60">
                How It Works
              </Link>
              <a
                href="https://github.com/onenoly1010/quantum-pi-forge-fixed"
              ...
              <a
                href="https://explorer.0g.ai/token/0xbEbC1A40A18632CeE19D220647E7aD296A1A5F37"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white/60"
              >
          ...
          <div className="text-center mt-8 text-white/30 text-xs">
            Built for the Truth Movement • Frequency: 1010 Hz • The Forge stands
            sovereign.
          </div>
        </div>
      </footer>
