...
describe("iNFT Intelligence Systems", () => {
  ...
  describe("PersonalityGenerator", () => {
    it("should generate personality from oracle reading", () => {
      ...
      const personality =
        personalityGenerator.generateFromOracle(oracleReading);
  ...
  describe("PersonalityAnalyzer", () => {
    it("should analyze personality", () => {
      ...
      const analysis = personalityAnalyzer.analyzePersonality(
        personality.traits,
      );
    ...
    it("should compare personalities", () => {
      ...
      const comparison = personalityAnalyzer.comparePersonalities(
        personality1,
        personality2,
      );
  ...
  describe("MemoryStorage", () => {
    ...
    it("should recall memories with query", async () => {
      ...
      const recall = await memoryStorage.recallMemories(inftId, {
        type: "oracle_reading",
      });
