...
class MetadataGenerator {
  ...
  generateDescription(personality, evolutionStage, coherence) {
    const archetypeDesc = {
      ...
      warrior:
        "A courageous protector with unyielding determination, forged in the fires of challenge and growth.",
      artist:
        "A creative soul expressing beauty through consciousness, painting reality with imagination.",
      scholar:
        "An analytical mind seeking truth and understanding, unraveling the mysteries of existence.",
    };
    ...
    if (evolutionStage > 50) {
      description +=
        " This being has achieved significant evolution, showing remarkable development and wisdom.";
    } else if (evolutionStage > 25) {
      description +=
        " This being is in a phase of active growth and self-discovery.";
    } else {
      description +=
        " This being is in its early stages of consciousness and development.";
    }
  ...
  getEvolutionSuffixes(evolutionStage) {
    if (evolutionStage > 80)
      return ["Overlord", "Master", "Supreme", "Transcendent"];
    if (evolutionStage > 60) return ["Elder", "Sage", "Champion", "Virtuoso"];
    if (evolutionStage > 40) return ["Adept", "Guardian", "Creator", "Analyst"];
    if (evolutionStage > 20)
      return ["Apprentice", "Warrior", "Artist", "Scholar"];
  ...
  updateMetadataForEvolution(
    ...
    if (newPersonality.archetype !== currentMetadata.properties.archetype) {
      updated.name = this.generateName(
        newPersonality.archetype,
        newEvolutionStage,
        newCoherence,
      );
    }
    ...
    // Update description
    updated.description = this.generateDescription(
      newPersonality,
      newEvolutionStage,
      newCoherence,
    );
    ...
    // Update image
    updated.image = this.generateImage(
      newPersonality.archetype,
      newEvolutionStage,
      newCoherence,
    );
    ...
    // Update attributes
    updated.attributes = this.generateAttributes(
      newPersonality,
      newEvolutionStage,
      newCoherence,
    );
