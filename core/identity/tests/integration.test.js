...
describe("Identity System Integration", () => {
  ...
  describe("Profile Management Flow", () => {
    it("should create and update soul profiles", async () => {
      ...
      // Create profile
      const createResult = await profileService.updateSoulProfile(
        testSoulId,
        {
    ...
    it("should manage reading history", async () => {
      ...
      // Get history
      const historyResult =
        await profileService.getSoulReadingHistory(testSoulId);
  ...
  describe("Data Validation", () => {
    ...
    } = require("../utils/validation/data-validation");
  ...
  describe("Data Conversion", () => {
    const {
      convertTraitScale,
      piProfileToOinio,
    } = require("../utils/conversion/data-conversion");

    it("should convert trait scales", () => {
      const decimalTraits = { openness: 0.75 };
      const percentageTraits = convertTraitScale(
        decimalTraits,
        "decimal",
        "percentage",
      );
