...
@Component({
  ...
  template: `
    ...
    <div
      class="min-h-screen bg-gray-50 antialiased"
    ...
    >
      ...
      <header class="bg-violet-800 shadow-lg sticky top-0 z-10">
        ...
        >
          <h1
            class="text-2xl font-bold font-['Space Grotesk'] text-white tracking-wider"
          >
            Sovereign Canticle Forge
          </h1>
      ...
      <main
        class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid grid-cols-1 lg:grid-cols-4 gap-8"
      >
        <!-- Score Panel (Fixed/Sticky on large screens) -->
        <aside class="lg:col-span-1">
          <div
            class="bg-white p-6 rounded-xl shadow-xl border border-gray-100 sticky lg:top-24"
          >
            <h2
              class="text-xl font-bold font-['Space Grotesk'] text-gray-800 mb-4 border-b pb-2"
            >
              Velvet Verdict
            </h2>
            ...
            <div class="text-center py-6">
              ...
              <div
                class="font-['Space Grotesk'] font-extrabold transition-all duration-500"
            ...
            <div
              class="p-3 rounded-lg text-center font-semibold border-2"
            ...
            <div class="mt-4 text-xs text-gray-500 space-y-2 pt-4 border-t">
              ...
              <p>
                P2 (Consensus) Score: {{ P2Score()?.toFixed(1) || "0.0" }} / 100
              </p>
              <p>
                P3 (Communal) Score: {{ P3Score()?.toFixed(1) || "0.0" }} / 100
              </p>
              <p *ngIf="isCriticalFailure()" class="text-red-500 font-bold">
                CRITICAL FAILURE: LP UNLOCKED
              </p>
              <p *ngIf="P1RiskMultiplier() === 0.7" class="text-yellow-600">
                P1 Multiplier Applied (Proxy Risk)
              </p>
            </div>
            ...
            <div class="mt-6 text-center">
              <button
                (click)="resetForm()"
                class="text-xs text-violet-600 hover:text-red-500 transition"
              >
                Reset All Answers
              </button>
            </div>
        ...
        <section class="lg:col-span-3 space-y-10">
          <div
            *ngFor="let phase of [1, 2, 3]; let phaseIndex = index"
            class="bg-white p-6 md:p-8 rounded-xl shadow-xl border border-gray-100"
          >
            <h2
              class="text-2xl font-bold font-['Space Grotesk'] text-violet-700 mb-6 border-b pb-3"
            >
              Phase {{ phase }}: {{ getPhaseTitle(phase) }}
              <span class="text-base text-gray-500 font-normal"
                >({{ getPhaseWeight(phase) }}% Weight)</span
              >
            </h2>

            <div
              *ngFor="let q of questionList.filter(getFilterByPhase(phase))"
              class="mb-6 p-4 border border-gray-100 rounded-lg"
            ...
            >
              ...
              >
                ...
                <span
                  *ngIf="q.dependencies"
                  class="text-xs text-blue-500 italic ml-2"
                  >(Conditional)</span
                >
              </label>
              ...
              <div [ngSwitch]="q.type">
                ...
                <ng-container *ngSwitchCase="'boolean'">
                  ...
                  <!-- Link/Evidence Field -->
                  <div
                    *ngIf="q.id !== '2.3' && getAnswer(q.id) === true"
                    class="mt-3"
                  >
                    <input
                      type="url"
                      (input)="
                        updateAnswer(q.id + '_link', $event.target.value)
                      "
                  ...
                  <div class="space-y-2">
                    <div
                      *ngFor="let option of q.options"
                      ...
                      [ngClass]="{
                        'border-violet-600 bg-violet-50 text-violet-800 font-medium shadow-sm':
                          isSelected(q.id, option.value),
                    ...
                    >
                      <svg
                        [ngClass]="{
                          'opacity-100': isSelected(q.id, option.value),
                          'opacity-0': !isSelected(q.id, option.value),
                        }"
                        class="w-5 h-5 mr-3 text-violet-600 transition"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                ...
                <ng-container *ngSwitchCase="'numeric'">
                  <div class="flex items-center space-x-2">
                    ...
                    />
                    <span *ngIf="q.unit" class="text-gray-500">{{
                      q.unit
                    }}</span>
                  </div>
                </ng-container>
...
export class App implements OnInit {
  ...
  private questions: Question[] = [
    // PHASE 1: CODE SOVEREIGNTY (10 Questions)
    {
      id: "1.1",
      phase: 1,
      text: "Is the full, final source code for all audited contracts publicly accessible?",
      type: "boolean",
      metricType: "Binary",
    ...
    },
    {
      id: "1.2",
      phase: 1,
      text: "Are the contracts verified on the Pi Network explorer?",
      type: "boolean",
      metricType: "Binary",
    },
    {
      id: "1.3",
      phase: 1,
      text: "Which best describes the project's license?",
      type: "multi-select",
      metricType: "Categorical Weight",
      options: [
        { value: "OSI", label: "OSI-Approved (e.g., MIT/GPL)", score: 100 },
        { value: "Project", label: "Project-Specific", score: 50 },
        { value: "None", label: "None/All Rights Reserved", score: 0 },
      ],
    },
    {
      id: "1.4",
      phase: 1,
      text: "Does the contract utilize a proxy/upgradeability pattern?",
      type: "boolean",
      metricType: "Binary",
    },
    {
      id: "1.5",
      phase: 1,
      text: "Are any functions protected by a timelock or multisig?",
      type: "boolean",
      metricType: "Binary",
      dependencies: { targetId: "1.4", requiredValue: true },
    },
    {
      id: "1.6",
      phase: 1,
      text: "Does the contract contain functions that allow for: (Select all that apply)",
      type: "multi-select",
      metricType: "Risk Vector Count",
      options: [
        { value: "Minting", label: "Minting new tokens", score: 20 },
        { value: "Fees", label: "Changing fees", score: 20 },
        { value: "Halt", label: "Halting trades", score: 20 },
        { value: "Blacklist", label: "Blacklisting addresses", score: 20 },
        { value: "Logic", label: "Changing core logic", score: 20 },
      ],
    },
    {
      id: "1.7",
      phase: 1,
      text: "Is there a documented, tested procedure for relinquishing ownership/control?",
      type: "boolean",
      metricType: "Binary",
    },
    {
      id: "1.8",
      phase: 1,
      text: "Are the project's key dependencies from reputable, audited sources?",
      type: "boolean",
      metricType: "Binary",
    },
    {
      id: "1.9",
      phase: 1,
      text: "Is a comprehensive test suite provided, with coverage >80%?",
      type: "boolean",
      metricType: "Binary",
    ...
    },
    {
      id: "1.10",
      phase: 1,
      text: "Has the code been analyzed by any automated security tools (Slither, MythX)?",
      type: "boolean",
      metricType: "Binary",
      placeholder: "Link to Report",
    },
    ...
    // PHASE 2: CONSENSUS INTEGRITY (9 Questions)
    {
      id: "2.1",
      phase: 2,
      text: "What is the primary token distribution model?",
      type: "multi-select",
      metricType: "Categorical Weight",
      options: [
        { value: "Fair", label: "Fair Launch (no pre-mine)", score: 100 },
        { value: "Pre-sale", label: "Pre-sale/Vesting", score: 70 },
        { value: "Airdrop", label: "Airdrop", score: 80 },
        { value: "Mining", label: "Mining/Staking", score: 90 },
        { value: "Treasury", label: "Treasury Controlled", score: 30 },
      ],
    },
    {
      id: "2.2",
      phase: 2,
      text: "What percentage of the total supply is allocated to the team/founders?",
      type: "numeric",
      metricType: "Linear Scale",
      min: 0,
      max: 100,
      unit: "%",
    },
    {
      id: "2.3",
      phase: 2,
      text: "Is the liquidity pool (LP) tokens locked or burned?",
      type: "boolean",
      metricType: "Binary",
      placeholder: "Link to Lock Contract",
    },
    {
      id: "2.4",
      phase: 2,
      text: "If locked, what is the lock duration?",
      type: "numeric",
      metricType: "Linear Scale",
      min: 0,
      unit: "Months",
      dependencies: { targetId: "2.3", requiredValue: true },
    },
    {
      id: "2.5",
      phase: 2,
      text: "Is the governance model on-chain?",
      type: "boolean",
      metricType: "Binary",
    },
    {
      id: "2.6",
      phase: 2,
      text: "Can voting power be delegated? (Bonus)",
      type: "boolean",
      metricType: "Binary",
    },
    {
      id: "2.7",
      phase: 2,
      text: "Is there a mechanism to prevent whale dominance in governance? (Bonus)",
      type: "boolean",
      metricType: "Binary",
    },
    {
      id: "2.8",
      phase: 2,
      text: "Is the treasury multi-signature or governed by a DAO?",
      type: "boolean",
      metricType: "Binary",
    },
    {
      id: "2.9",
      phase: 2,
      text: "Are the project's financial flows publicly viewable on-chain?",
      type: "boolean",
      metricType: "Binary",
    },
    ...
    // PHASE 3: COMMUNAL ALIGNMENT (8 Questions)
    {
      id: "3.1",
      phase: 3,
      text: "Is there clear, accessible documentation for non-technical users?",
      type: "boolean",
      metricType: "Binary",
    ...
    },
    {
      id: "3.2",
      phase: 3,
      text: "Are the project's social channels active and publicly accessible?",
      type: "boolean",
      metricType: "Binary",
      placeholder: "Links to Channels",
    },
    {
      id: "3.3",
      phase: 3,
      text: "Is there a published roadmap with clear, time-bound milestones?",
      type: "boolean",
      metricType: "Binary",
    ...
    },
    {
      id: "3.4",
      phase: 3,
      text: "Does the project have a clear, enforced code of conduct for its community spaces?",
      type: "boolean",
      metricType: "Binary",
      placeholder: "Link to CoC",
    },
    {
      id: "3.5",
      phase: 3,
      text: "Is the dApp interface designed with accessibility in mind?",
      type: "multi-select",
      metricType: "Categorical Weight",
      options: [
        { value: "WCAG", label: "WCAG 2.1 AA Compliant", score: 100 },
        { value: "Stated", label: "Stated Commitment", score: 60 },
        { value: "None", label: "Not Addressed", score: 0 },
      ],
    },
    {
      id: "3.6",
      phase: 3,
      text: "What is the project's policy on user data?",
      type: "multi-select",
      metricType: "Categorical Weight",
      options: [
        { value: "UserOwned", label: "User-Owned Data", score: 100 },
        { value: "Minimized", label: "Data Minimized & Encrypted", score: 80 },
        { value: "NoneCollected", label: "No Data Collected", score: 60 },
        { value: "NotStated", label: "Policy Not Stated", score: 0 },
      ],
    },
    {
      id: "3.7",
      phase: 3,
      text: "Does the project have a mechanism for community members to report bugs or vulnerabilities?",
      type: "boolean",
      metricType: "Binary",
      placeholder: "Link to Bug Bounty/Report Form",
    },
    {
      id: "3.8",
      phase: 3,
      text: "Has the project contributed back to the Pi Network ecosystem? (Bonus)",
      type: "boolean",
      metricType: "Binary",
      placeholder: "Description/Evidence",
    },
  ];
  ...
  toggleMultiSelect(id: string, value: string) {
    ...
    if (
      this.questions.find((q) => q.id === id)?.metricType ===
      "Categorical Weight"
    ) {
      ...
      switch (q.metricType) {
        ...
        case "Linear Scale":
          ...
          if (q.id === "2.2") {
            ...
            if (value < 12)
              score = 0; // Critical failure for score, but P2 score will average it
  ...
  public finalScore = computed<ScoreResult>(() => {
    ...
    const scoreValue = p1 * 0.45 + p2 * 0.4 + p3 * 0.15;
