...
npm run setup:tracing

# Start trace collector (in VSCode)
npm run trace:start
```

### Run AI Components with Tracing

```bash
# DeepSeek Guardian with tracing
npm run guardian

# AI Nexus Synchronization
npm run nexus

# Sovereign Economic Oracle
npm run oracle

# Quantum Resonance Field
npm run quantum

# FastAPI backend with tracing
npm run fastapi
```
...
- **AI Toolkit**: Integrated trace collection and visualization
- **gRPC OTLP**: Efficient trace transport to localhost:4317
- **Automatic Instrumentation**: HTTP requests, database calls, and custom spans
