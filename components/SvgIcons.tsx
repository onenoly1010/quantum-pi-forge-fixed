...
export function QuantumOrbitSVG({
  className = "w-8 h-8",
}: {
  className?: string;
}) {
...
export function VRGlassesSVG({
  ...
  return (
    ...
    >
      <path
        d="M17 8h1a4 4 0 110 8h-1M7 8h-1a4 4 0 100 8h1"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
export function TrophySVG({ className = "w-8 h-8" }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M5 15v4a2 2 0 002 2h10a2 2 0 002-2v-4M12 15v6"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
