...
async function verifyOINIOToken() {
  ...
  try {
    ...
    console.log(
      `🔗 Explorer: ${CONFIG.EXPLORER_URL}/address/${CONFIG.OINIO_TOKEN}`,
    );
    ...
    try {
      ...
      await tokenContract.mint.staticCall(
  ...
  try {
    ...
    console.log(
      `🔗 Explorer: ${CONFIG.EXPLORER_URL}/address/${CONFIG.DEX_FACTORY}`,
    );
    ...
    if (pairAddress !== "0x0000000000000000000000000000000000000000") {
      ...
      console.log(
        `💰 Reserves: ${ethers.formatEther(reserve0)} ${token0 === CONFIG.OINIO_TOKEN ? "OINIO" : "0G"} / ${ethers.formatEther(reserve1)} ${token1 === CONFIG.OINIO_TOKEN ? "OINIO" : "0G"}`,
      );
      ...
      console.log(
        `🔥 LP Tokens at Dead Address: ${ethers.formatEther(deadBalance)}`,
      );
