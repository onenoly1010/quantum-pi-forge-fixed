...
const Toast: React.FC<{
  ...
  return (
    <div
      className={`p-4 rounded-xl border ${bgColors[toast.type]} animate-in slide-in-from-top-2 duration-200`}
    >
      <div className="flex items-start">
        <span className={`font-medium ${textColors[toast.type]}`}>
          {toast.title}
        </span>
        <button
  ...
  return (
    <div className={`mb-6 p-4 rounded-xl border ${config.bg}`}>
      <div className="flex items-center">
        {config.icon}
        <span className={`ml-3 font-medium ${config.textColor}`}>
          {status.message}
        </span>
        <button
          onClick={onDismiss}
      ...
      {status.status === "error" &&
        ...
        status.retryCount < MAX_RETRIES && (
          ...
          >
            Retry Transaction ({MAX_RETRIES - status.retryCount} attempts
            remaining)
          </button>
        )}
    </div>
          ...
          <div className="relative max-w-7xl mx-auto px-6 py-8">
            ...
            <div className="text-center py-16">
              ...
              <p className="text-xl text-white/60 max-w-2xl mx-auto mb-8">
                Stake OINIO tokens with zero gas fees. Join the Truth Movement
            ...
            <div className="lg:col-span-2 rounded-2xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] border border-white/10 p-6">
              ...
              <div className="space-y-4">
                ...
                <button
                  onClick={handleStake}
                  disabled={
                    !isConnected || !stakingAmount || isStaking || !isOnline
                  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <div className="rounded-2xl bg-gradient-to-br from-white/[0.05] to-transparent border border-white/5 p-6">
              ...
              <p className="text-white/40 text-sm leading-relaxed">
                Stake your OINIO tokens instantly without waiting for
                confirmations. Our gasless system handles everything.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-gradient-to-br from-white/[0.05] to-transparent border border-white/5 p-6">
              ...
              <p className="text-white/40 text-sm leading-relaxed">
                Built on Polygon with battle-tested smart contracts. Your assets
            ...
            <div className="rounded-2xl bg-gradient-to-br from-white/[0.05] to-transparent border border-white/5 p-6">
              ...
              <p className="text-white/40 text-sm leading-relaxed">
                We sponsor all transaction fees. Stake any amount without
                worrying about MATIC or gas costs.
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="flex items-center space-x-3 mb-4 md:mb-0">
                ...
                <span className="text-white/60 text-sm">
                  OINIO • Sovereign Staking Protocol
                </span>
              </div>
