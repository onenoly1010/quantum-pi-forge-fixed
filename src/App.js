...
export default function App() {
  ...
  async function connect() {
    ...
    try {
      ...
      setStatus(
        "❌ Auth canceled or failed: " + (e.message || "Unknown error"),
      );
  ...
  return (
    ...
    >
      ...
      {!window.Pi && (
        ...
        >
          <strong>ℹ️ Development Preview:</strong> This demo simulates the Pi
          connection. When deployed to Pi Network and opened in the Pi Browser,
          users will authenticate with their real Pi accounts.
        </div>
      )}
    </div>
  );
